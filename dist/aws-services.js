...
import { DescribeClustersCommand, DescribeTasksCommand, ListClustersCommand, ListServicesCommand, ListTasksCommand, } from "@aws-sdk/client-ecs";
import { DescribeDBInstancesCommand, } from "@aws-sdk/client-rds";
export async function getECSClusters(ecsClient) {
    try {
...
export async function getECSTasks(ecsClient, cluster) {
    try {
...
export async function getAWSRegions(ec2Client) {
    try {
...
export async function getRDSInstances(rdsClient) {
    try {
